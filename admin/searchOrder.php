...
?>
            ...
            <div class="mt-5 card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="d-grid col-4">
                            <button class="mt-2 btn btn-success" onclick="process('<?php echo $order["order_id"] ?>')">Process</button>
                            <button class="mt-2 btn btn-warning" onclick="goToOtherDetails('<?php echo $order["order_id"] ?>');">Other Details</button>
            ...
            <div class="mt-5 card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="d-grid col-4">
                            <button class="mt-2 btn btn-success" onclick="shipped('<?php echo $order["order_id"] ?>')">Shipped</button>
                            <button class="mt-2 btn btn-danger" onclick="goToOtherDetails('<?php echo $order["order_id"] ?>');">Other Details</button>
            ...
            <div class="mt-5 card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="d-grid col-4">
                            <button class="mt-2 btn btn-warning" onclick="complete('<?php echo $order["order_id"] ?>')">Completed</button>
                            <button class="mt-2 btn btn-danger" onclick="goToOtherDetails('<?php echo $order["order_id"] ?>');">Other Details</button>
    ...
    if ($order_num == 0) {
        ...
        <div class="mt-5 col-12">
            <div class="mt-5 row">
                <div class="text-black-50 offset-4 col-4">
                    <h3>No Complete Orders (Today) </h3>
                </div>
            </div>
        </div>
        <?php
            ...
            <div class="mt-5 card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="d-grid col-4">
                            <button style="height: 40px;" class=" mt-2 btn btn-danger" onclick="goToOtherDetails('<?php echo $order["order_id"] ?>');">Other Details</button>
    ...
    if ($order_num == 0) {
        ...
        <div class="mt-5 col-12">
            <div class="mt-5 row">
                <div class="text-black-50 offset-4 col-4">
                    <h3>No Cancelled Orders (Today)</h3>
                </div>
            </div>
        </div>
        <?php    } else {
