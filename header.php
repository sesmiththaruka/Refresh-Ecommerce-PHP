        ...
        <div class="mb-5 row">
            <div class=" col-12 mb-5 fixed-top text-white " style="background-color:#7e5a002f; ">
                <div class="row headfirst">
                    ...
                    <div class="d-none d-lg-block fs-6 col-md-3 col-7 col-lg-4 align-self-start" style="color:#DAA520;">
                        ...
                        <span class=" ms-5" onclick="goTomsg"> Contact Us </span>
                    </div>
                    ...
                    <div class="offset-lg-5  col-9 col-md-6 col-lg-3 align-self-end">
                        <div class="row  mb-3">
                            ...
                            ?>
                                ...
                                <div class="col-6  col-lg-6 col-md-6 dropdown">
                                ...
                                <div onclick="gotocart();" class="offset-0 offset-lg-0 col-4  col-lg-3 col-md-3 mt-1  ms-lg-0 carticon" style="cursor: pointer;"></div>


                            <?php
                            } else {
                            ?>
                                <a href="sign/signin.php" class="fs-6 ms-1" style="text-decoration: none; color:#DAA520"><i class="fs-3 mt-3 me-2 bi bi-person"></i>Sign In or Sign Up</a>
                            <?php
                            }
                            ?>
